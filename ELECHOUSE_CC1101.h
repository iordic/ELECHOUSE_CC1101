...
class ELECHOUSE_CC1101 {
  ...
  public:
    ELECHOUSE_CC1101(byte gdo0, byte gdo2);
    ELECHOUSE_CC1101(byte gdo0, byte gdo2, int spi);
    ELECHOUSE_CC1101(byte gdo0, byte gdo2, byte sck, byte miso, byte mosi, byte csn, int spi);
    void init();
    void spiEnd();
    void reset();
